...
const PhoneService = {
    ...
    getPhonesSortedByName() {
        return phonesSortedByName;
    },

    getPhoneFromSearchEngine() {
        function compareRandom(a, b) {
            return Math.random() - 0.5;
        }
        return phonesSearchResponse.sort(compareRandom);
    },
